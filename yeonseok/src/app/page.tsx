          ...
          <div className="flex items-center gap-8">
            ...
            {isLoggedIn && (
              <div className="hidden md:flex items-center gap-6 text-sm">
                ...
                <Link href="/goal" className="text-slate-600 hover:text-slate-900 transition font-medium">
                  레시피 검색
                </Link>
                <Link href="/recipe" className="text-slate-600 hover:text-slate-900 transition font-medium">
                  마이페이지
                </Link>
                <Link href="/recommendation" className="text-slate-600 hover:text-slate-900 transition font-medium">
                  고객센터/문의
                </Link>
              </div>
            )}
